...
from .views import create_project, delete_project, update_project, get_clients_project_list, get_project_list, get_projects_total, get_project, update_project_status
